...
HA_SL_MIN_PIPS    = 10    # floor: wider minimum to handle GBPJPY noise
HA_SL_MAX_PIPS    = 18    # ceiling: wider ceiling for GBPJPY's high ATR
...
def build_signal(h1_bias: dict, entry: Optional[dict], symbol: str = "EURUSD") -> Signal:
    """
