...
Stop loss:   HA_SL_MIN_PIPS (10 pip floor). ATR_TRAIL_MULT = 0.4 drives the
             Phase 2 trailing stop, not the initial SL — ATR × 0.4 always
             falls below the floor for AUDUSD H1 ATR values.
